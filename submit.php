...
//  }
  ...
  $add = "INSERT INTO redo (name, age, code,gender,contact) VALUES ('$name', '$age', '$code','$gender','$contact');";

  $result = mysqli_query($conn,$add);

  if ($result) { ?>
    <h5><?php echo "patient details were recorded successfully"; ?></h5>


    <br> <h5> <button type="button" name="button"><a href="index.php"> Back to Registration  </a></button> </h5> 
<!--    <a class="float-right" href="logout.php">Logout</a> -->
