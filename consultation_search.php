...
if (isset($_POST['consultation-search-btn'])) {
  //Searched Data is stored in a variable.
  $search = mysqli_real_escape_string($conn,$_POST['consultation-search']);
  //Query to perform the search operation
  $query = "SELECT * FROM daily WHERE name LIKE '%$search%'  OR age LIKE '%$search%'
