...
<?php
if (isset($_GET['consultation_edit'])) {

  $no=$_GET['consultation_edit'];
  $res=mysqli_query($conn,"SELECT * FROM daily WHERE no='$no'");
  $row=mysqli_fetch_array($res);
}
   ?>
<form class="" method="post">
   <button type="submit" name="list" formaction="consultation_list.php">Back to Total Patients</button>
</form>
       <a href="index.php">Back to Registration</a>
       <a class="float-right" href="logout.php">Logout</a>
    <?php
/*if (isset($_POST['newName']) || isset($_POST['newCode']) || isset($_POST['newAge']) || isset($_POST['consultation']) || isset($_POST['newDate']) || isset($_POST['enter']) || isset($_POST['newContact'])) {
  ...
  $no=$_POST['no'];
  $sql="UPDATE daily SET name='$newName',age='$newAge',date='$newDate',code='$newCode',contact='$newContact',consultation='$consultation' WHERE no='$no'";
 ...
 <form class=""  method="post">
   <table>
   <tr>
  <td>name<input type="text" name="newName" value="<?php echo $row['name']; ?>"></td>
</tr>
<tr>
<td>token<input type="number" name="newCode" value="<?php echo $row['code']; ?>"></td>
</tr>
<tr>
<td>age<input type="number" name="newAge" value="<?php echo $row['age']; ?>"></td>
</tr>
<tr>
<td>date<input type="text" name="newDate" value="<?php echo $row['date']; ?>"></td>
</tr>
<tr>
<td>contact<input type="number" name="newContact" value="<?php echo $row['contact']; ?>"></td>
</tr>
<tr>
<td><textarea name="consultation" rows="8" cols="80" ><?php echo $row['consultation']; ?></textarea></td>
</tr>
<tr>
  <td><input type="hidden" name="no" value="<?php echo $row['no']; ?>"><br></td>
</tr>
<tr>
  <td> <input type="submit" name="" value="enter" formaction="sample.php"> </td>
</tr>
<tr>
  <td><button type="submit" name="list" formaction="consultation_list.php">Daily Consultation List</button></td>
</tr>
 </form>
</table>
</div>
