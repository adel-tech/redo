...
if (isset($_GET['consultation_delete'])) {
  $no = $_GET['consultation_delete'];
  $deleteQuery = "DELETE FROM daily WHERE no=$no;";

  $delete = mysqli_query($conn,$deleteQuery);
  if ($delete) {
    echo "<h4>"."record deleted"."</h4>";
    ?> <form  method="post">
      <button type="submit" name="list" formaction="consultation_list.php">Back to consultation list</button>
    </form>
   ...
   echo "<h4>"."record couldnt be deleted"."</h4>";
   ?><form  method="post">
     <button type="submit" name="list" formaction="consultation_list.php">Back to consultation list</button>
   </form>
    <a href="index.php"><button> Back to Registration </button></a>  <?php
  }
}
?>
</div>
