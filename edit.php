...
<p><button type="button" name="button"><a href="all.php">Back to Total Patients</a></button>
<button type="button" name="button"><a href="index.php">Back to Registration</a></button></p>

    <!--   <a class="float-right" href="logout.php">Logout</a> -->
    <?php
/*if (isset($_POST['newName']) || isset($_POST['newCode']) || isset($_POST['newAge']) || isset($_POST['newDate']) || isset($_POST['enter']) || isset($_POST['newContact'])) {
  ...
  $no=$_POST['no'];
  $sql="UPDATE redo SET name='$newName',age='$newAge',date='$newDate',code='$newCode',contact='$newContact' WHERE no='$no'";
...
<tr>
  <td> <input type="submit" name="" value="enter" formaction="rough.php"> </td>
</tr>
<tr>
