...
if (isset($_GET['consultation'])) {
  ...
  $row=mysqli_fetch_array($res);
   ...
   ?> <form method="post">
     <button type="submit" name="display" formaction="display.php">Back to total patients</button>
   </form>
...
<tr>
  <td><textarea name="consultation" rows="8" cols="80" placeholder="Enter consultation details"></textarea><br>
</td>
</tr>
<tr>
  <td> <input type="submit" name="" value="enter" formaction="enter.php"> </td>
</tr>
<tr>
